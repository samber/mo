...
func Match[In1 any, In2 any, In3 any, In4 any, In5 any, Out1 any, Out2 any, Out3 any, Out4 any, Out5 any](onArg1 func(In1) Out1, onArg2 func(In2) Out2, onArg3 func(In3) Out3, onArg4 func(In4) Out4, onArg5 func(In5) Out5) func(either mo.Either5[In1, In2, In3, In4, In5]) mo.Either5[Out1, Out2, Out3, Out4, Out5] {
	return func(either mo.Either5[In1, In2, In3, In4, In5]) mo.Either5[Out1, Out2, Out3, Out4, Out5] {
		if either.IsArg1() {
			return mo.NewEither5Arg1[Out1, Out2, Out3, Out4, Out5](onArg1(either.MustArg1()))
		}

		if either.IsArg2() {
			return mo.NewEither5Arg2[Out1, Out2, Out3, Out4, Out5](onArg2(either.MustArg2()))
		}

		if either.IsArg3() {
			return mo.NewEither5Arg3[Out1, Out2, Out3, Out4, Out5](onArg3(either.MustArg3()))
		}

		if either.IsArg4() {
			return mo.NewEither5Arg4[Out1, Out2, Out3, Out4, Out5](onArg4(either.MustArg4()))
		}

		return mo.NewEither5Arg5[Out1, Out2, Out3, Out4, Out5](onArg5(either.MustArg5()))
	}
}
...
func MapArg2[In1 any, In2 any, In3 any, In4 any, In5 any, Out2 any](f func(In2) Out2) func(either mo.Either5[In1, In2, In3, In4, In5]) mo.Either5[In1, Out2, In3, In4, In5] {
	return func(either mo.Either5[In1, In2, In3, In4, In5]) mo.Either5[In1, Out2, In3, In4, In5] {
		return Match(
...
func MapArg3[In1 any, In2 any, In3 any, In4 any, In5 any, Out3 any](f func(In3) Out3) func(either mo.Either5[In1, In2, In3, In4, In5]) mo.Either5[In1, In2, Out3, In4, In5] {
	return func(either mo.Either5[In1, In2, In3, In4, In5]) mo.Either5[In1, In2, Out3, In4, In5] {
		return Match(
			func(arg1 In1) In1 { return arg1 },
			func(arg2 In2) In2 { return arg2 },
